...
// 제가 생각해도 너무나도 부족한 것 같아요... 어찌어찌 물 새는 곳만 막아보자라는 식으로 한것 같아 많이 부끄럽기도 해요...
// ViewTokenHistory를 할 때는 gas Limitaion error가 뜨고... 구글링 해봐도 해법을 못찾겠어요...(핑계이지만...ㅎ) 그래도 부끄럽더라도 올려봅니다...
// 따끔하게 그치만 아프지 않게 댓글로 때려주세요...! 채찍으로 많이 성장하겠습니다!!!!
