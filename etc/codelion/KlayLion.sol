...
contract NFTSimple {
    ...
    // transferFrom(from, to, tokenId) -> ownerÍ∞? Î∞îÎ?åÎäî Í≤?(from -> to)
    ...
    function mintWithTokenURI(
        ...
        // to?óêÍ≤? tokenId(?ùº?†®Î≤àÌò∏)Î•? Î∞úÌñâ?ïòÍ≤†Îã§.
        // ?†Å?ûê Í∏??ûê?äî tokenURI
    ...
    function _removeTokenFromList(address from, uint256 tokenId) private {
        // [10, 15, 19, 20] -> 19Î≤àÏùÑ ?Ç≠?†ú ?ïòÍ≥? ?ã∂?ñ¥?öî
        // [20, 15, 20, 19]
        // [10, 15, 20]
